...
#endif
    FLASH_WriteBuffer((uint8_t*)Writebuff, Memory_Offset, Transfer_Length);
    return MAL_OK;
}
...
#endif
    FLASH_ReadBuffer((uint8_t*)Readbuff, Memory_Offset, Transfer_Length);
    return MAL_OK;
}
...
uint16_t MAL_GetStatus (uint8_t lun)
{
    ...
    Mass_Block_Count[0] = taille / FLASH_PAGE_SIZE;
