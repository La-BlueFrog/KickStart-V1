...
//
#define GUI_NUMBYTES  (1024) *  27   // 27 KBytes - leave space for stack etc.

// Segger documentation on-line for FlexColor driver says:
// RAM requirements ~500 bytes,
// add LCD_XSIZE * LCD_YSIZE * BtesPerPixel to use a display cache
...
U32 MyMem[GUI_NUMBYTES / 4];  //declared as static in some example on the web
...
void GUI_X_Config(void)
{
  ...
  GUI_ALLOC_AssignMemory(MyMem, GUI_NUMBYTES);
  // Assigns a memory block for the memory management system
