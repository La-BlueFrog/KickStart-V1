...
int8_t STORAGE_Inquirydata[] = { /* 36 */
  ...
  0x00,	
  0x00,
  'L', 'B', 'F', ' ', ' ', ' ', ' ', ' ', /* Manufacturer: 8 bytes  */
  'L', 'a', ' ', 'B', 'l', 'u', 'e', 'F', /* Product     : 16 Bytes */
  'r', 'o', 'g', ' ', 'V', '2', ' ', ' ',
...
int8_t STORAGE_GetCapacity(	uint8_t lun, 
				...
				uint16_t *block_size)
{
    *block_num =  FLASH_CAPACITY/STORAGE_BLK_SIZ  - 1;
    *block_size = STORAGE_BLK_SIZ; 
    // FLASH_CAPACITY is defined in LBF_FLASH_lowlevAPI.h
...
int8_t STORAGE_Read(	uint8_t lun, 
			...
			uint16_t blk_len)
{
    FLASH_ReadBuffer( buf, blk_addr * STORAGE_BLK_SIZ,  blk_len * STORAGE_BLK_SIZ);
    return 0; 
}
...
int8_t STORAGE_Write(	uint8_t lun, 
			...
			uint16_t blk_len)
{
    FLASH_WriteBuffer( buf, blk_addr * STORAGE_BLK_SIZ,  blk_len * STORAGE_BLK_SIZ);
    return 0;
}
